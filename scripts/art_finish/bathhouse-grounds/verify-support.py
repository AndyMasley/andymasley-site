...
root=Path(os.environ.get('WEBSTER_BATHHOUSE_GROUNDS','/private/tmp/webster-finished-game/art/bathhouse-grounds'))
...
rows=[];issues=[]
import json
catalog=json.loads((site/'data/derived/town/bathhouse-grounds.json').read_text())
