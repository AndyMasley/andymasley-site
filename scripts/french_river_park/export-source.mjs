/** Bound the native French River Park ground audit; placeholders establish geometry only. */
...
const out=process.env.WEBSTER_FRENCH_PARK_OUT||'/private/tmp/webster-french-river-park';
...
const manifest=JSON.parse(rawManifest),bounds=[-2965,-882,-2880,-770];
const ids=new Set(['-12_-4']);
