...
root=Path(os.environ.get('WEBSTER_COMMERCIAL_FRONTAGE','/private/tmp/webster-finished-game/main-frontage/native'))
...
rows=[];issues=[]
import json
catalog=json.loads((site/'data/derived/town/commercial-frontage-grounds.json').read_text())
...
assert sum(r['samples']for r in rows)>100, 'Missing actual forecourt mesh samples'
