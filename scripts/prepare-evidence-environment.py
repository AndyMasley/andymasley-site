...
objects=[obj('ENV-INF-BR-AC9','pony_bridge',-71.858855,42.055446,{'span':20.7264,'width':4.05,'rise':2.8956,'panels':9,'approachEndpoints':ends,'mappedCrossingLength':length,'sidewalkWidth':1.6129}),obj('ENV-MON-001','soldiers_monument',-71.880209,42.049818,{'height':12.192,'baseWidth':5.4864,'fenceRadius':4.6}),obj('ENV-MON-006','gazebo',-71.879975,42.049464,{'sides':11,'radius':3.05,'height':5.45}),obj('ENV-MON-007','trough',-71.881033,42.049331,{'width':1.6764,'depth':.9144,'height':.65}),obj('ENV-MON-003','korean_tablet',-71.880024,42.049793,{'width':1.25,'depth':.28,'height':1.55}),obj('ENV-MON-004','vietnam_rhombus',-71.879981,42.049813,{'width':1.55,'depth':.28,'height':1.35}),obj('ENV-MON-022','beach_flagpole',-71.856123,42.053878,{'height':10.0})]
