...
const STYLES: Record<Confidence, { label: string; color: string; bg: string }> = {
  estimated:    { label: 'Est.',    color: '#9A9A8A', bg: 'rgba(154,154,138,0.12)' },
  approximate:  { label: 'Approx.', color: '#B8860B', bg: 'rgba(184,134,11,0.10)' },
  exact:        { label: 'Exact',   color: '#4A7C59', bg: 'rgba(74,124,89,0.10)' },
};
